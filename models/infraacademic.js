...
const infraacadmic = sequelize.define('infraAcademic', {
    collegeId:{
...
User.hasMany(infraacadmic, { foreignKey: 'collegeId' });
infraacadmic.belongsTo(User, { foreignKey: 'collegeId' });

module.exports = infraacadmic;