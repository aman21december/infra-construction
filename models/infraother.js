...
const infraother = sequelize.define('infraother', {
    collegeId:{
...
User.hasMany(infraother, { foreignKey: 'collegeId' });
infraother.belongsTo(User, { foreignKey: 'collegeId' });

module.exports = infraother;